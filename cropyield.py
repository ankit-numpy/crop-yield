...
features = data.drop(columns=['Production', 'Yield', 'Crop_Year'])  # Drop unnecessary columns
...
# Page title and Icon
st.set_page_config(
        page_title="Crop Yield Estimation",
        page_icon="🌾",
    )
...
if submit_button:
    total_yield, yield_per_hectare, pesticide, fertilizer = predict_and_estimate(crop, season, state, area_hectares, rainfall)
